...
namespace Config
{
	public class monitorConfig
	{
		...
		private void InitData(){
			...
			this.AllData.Add("25",new monitorCell("video_type_offlinereward_star","离线广告翻倍结束"));
			this.AllData.Add("26",new monitorCell("video_type_offlinereward_finish","离线广告翻倍结束"));
			this.AllData.Add("27",new monitorCell("video_type_goldreward_star","贵宾定时广告"));
			this.AllData.Add("28",new monitorCell("video_type_goldreward_finish","贵宾定时广告"));
		}
	}
