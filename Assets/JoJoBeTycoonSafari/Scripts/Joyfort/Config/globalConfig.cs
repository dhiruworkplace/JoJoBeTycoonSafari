...
namespace Config
{
	public class globalConfig
	{
		...
		///动物园终点车库资源组加载id
		///<summary>
		public readonly int EndPartResID= 5001;  
		///<summary>
		///动物园场景单组资源宽度参数
		///<summary>
		...
		///场景自带地块数
		///<summary>
		public readonly int DefaultOpenGroup= 1;  
		///<summary>
		///停车牌按钮
		///<summary>
		...
		///动物园场景默认开启组数
		///<summary>
		public readonly int ExtendLoadGroup= 1;  
		///<summary>
		///初始升级价格
		///<summary>
		...
		///动物培养开启所需星星
		///<summary>
		public readonly int AnimalupgradingNeed= 25;  
		///<summary>
		///游客表情最小缩放
		///<summary>
